...
export class DaySelector extends React.Component {
  ...
  onNext = () => {
    this.onChange(addDays(this.props.value, 1));
  }

  onPrev = () => {
    this.onChange(subDays(this.props.value, 1));
  }
...
class DatePicker extends React.Component {
  ...
  render() {
    return (
      <span>
        <SelectFromTo name="date" from={1} to={31} value={getDate(this.props.value)} onChange={this.onChange} />
